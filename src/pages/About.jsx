...
const EYEBROW_DARK_CLS = 'text-xs font-semibold uppercase tracking-[0.35em] text-[#A8C0DA]';
...
export default function About() {
  ...
  return (
    <div className="bg-[#DEE2E6] text-[#0E1A35] min-h-screen">
      <Navbar />

      {/* ── Tecrübe vurgusu (en üst, sola hizalı) ── */}
      <section data-nav-theme="light" className="bg-[#DEE2E6] border-b border-[#C8D0DA]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-28">
          <Reveal>
            <div className="grid items-end gap-8 md:grid-cols-[auto_1fr_auto] md:gap-12">
              <span className="block font-fraunces text-[140px] md:text-[200px] leading-[0.85] font-semibold text-[#0E1A35]">
                20<span className="text-[#6B8AAE]">+</span>
              </span>
              <div className="md:pb-6">
                <p className="text-xs uppercase tracking-[0.35em] text-[#6B8AAE] font-semibold">
                  {language === 'tr' ? 'Yıllık Tecrübe' : 'Years of Experience'}
                </p>
                <p className="mt-4 max-w-md text-lg leading-8 text-[#4A5876]">
                  {language === 'tr'
              ...
              <div className="hidden md:flex md:pb-6 items-center gap-3">
                <div className="h-px w-12 bg-[#6B8AAE]" />
                <p className="text-[10px] uppercase tracking-[0.35em] text-[#6B8AAE] font-semibold whitespace-nowrap">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 grid gap-14 lg:grid-cols-[1.2fr_0.8fr] items-start">
          <div className="space-y-14">
            ...
            <Reveal>
              ...
              <div className="mt-8 space-y-6 text-[17px] leading-8 text-[#4A5876]">
                <p>
                  {language === 'tr'
            ...
            <div className="border-t border-[#D6DCE3]" />
          ...
          <Reveal delay={0.2} from="right" className="lg:sticky lg:top-32">
            <figure className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-3/4 h-3/4 border border-[#6B8AAE]/30 pointer-events-none" />
              <figcaption className="absolute -top-4 -left-4 bg-[#6B8AAE] text-[#DEE2E6] px-5 py-3">
                <span className="font-fraunces text-2xl font-bold">2003</span>
                <p className="text-xs text-[#DEE2E6]/70 tracking-wider uppercase mt-0.5">
      ...
      <section data-nav-theme="light" className="bg-[#DEE2E6] border-b border-[#C8D0DA]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 py-24 text-center">
          <Reveal>
            ...
            <p className="mt-8 max-w-3xl mx-auto text-lg leading-8 text-[#4A5876]">
              {language === 'tr'
...
function ValuesShowcase({ language }) {
  ...
  return (
    <section
      ...
      className="relative bg-white border-b border-[#C8D0DA]"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 w-full">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] items-stretch">
            ...
            <div className="relative aspect-[4/5] lg:aspect-auto lg:min-h-[420px] overflow-hidden bg-ink">
              ...
              <div className="absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-[#6B8AAE]/20 blur-[100px]" />
              ...
              <div className="relative z-10 h-full w-full flex flex-col items-center justify-center p-10">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="w-32 h-32 md:w-40 md:h-40 border border-[#A8C0DA]/40 bg-white/[0.04] backdrop-blur-sm flex items-center justify-center"
                  >
                    <ActiveIcon className="w-14 h-14 md:w-16 md:h-16 text-[#A8C0DA]" strokeWidth={1.4} />
                  </motion.div>
                </AnimatePresence>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <span className="text-[#A8C0DA]">/{String(VALUES.length).padStart(2, '0')}</span>
                  </motion.p>
                </AnimatePresence>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-10 flex items-center gap-6">
                <div className="relative h-1 flex-1 bg-[#D6DCE3] overflow-hidden">
                  <motion.div
                    className="absolute inset-y-0 left-0 bg-[#6B8AAE]"
              ...
              <div className="flex-1 flex flex-col justify-center">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <h3 className="font-fraunces text-3xl md:text-4xl font-semibold leading-tight text-[#0E1A35]">
                      {current.title[language]}
                    </h3>
                    <p className="mt-6 text-[17px] leading-8 text-[#4A5876]">
                ...
                {VALUES.map((v, i) => (
                  <li
                    ...
                    className={`text-[10px] uppercase tracking-[0.15em] py-3 border-t-2 transition-colors ${
                      active === i
                        ? 'border-[#6B8AAE] text-[#0E1A35] font-semibold'
                        : 'border-[#D6DCE3] text-[#8FA0B5]'
                    }`}
                  >
          ...
          <p className="mt-8 text-center text-[10px] uppercase tracking-[0.3em] text-[#8FA0B5]">
