      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-8 py-10 md:grid-cols-[auto_1fr] md:items-center md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            <BrandLogo className="text-white" markClassName="h-10 w-10 text-base" textClassName="text-sm" />
            <div className="flex gap-2.5">
              {[Linkedin, Twitter, Instagram].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="flex h-8 w-8 items-center justify-center border border-white/20 text-[#c9d2e8] transition hover:border-[#B8CCDA] hover:text-[#B8CCDA]"
          ...
          <div className="md:text-right">
            <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-[#B8CCDA]">
